...
\[
a_n^n + a_{n-1}x^{n-1}+\dots+a_1x+a_0 = 0
\]
...
\begin{ejercicio}
    \begin{enumerate}
        \item Determine en forma gráfico los ceros de las siguientes funciones
        \[
        (a)\quad f(x)=x^2-8x+15 \qquad \qquad (b) \quad g(x) = 2x^2-4x-16
        \]
        \item Resuelva el problema 1 mediante la fórmula cuadrática.
