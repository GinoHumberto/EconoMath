...
Una vez que se consideran los precios de otros artículos, la estructura del modelo se debe ampliar, para producir los valores de equilibrio de estos otros precios. Como resultado, las variables de precio y cantidad de múltiples productos deben entrar juntos de forma endógena en el modelo.
...
\begin{ejercicio}
    \begin{enumerate}
        \item Desarrolle la solución de \(c_1P1+c_2P_2=-c_0\) y \(\gamma_1P_1+\gamma_2P_2=-\gamma_0\), paso a paso, y de este modo compruebe los resultados de \(P_1^\ast=(c_2\gamma_0-c_0\gamma_2)/(c_1\gamma_2-c_2\gamma_1)\) y de \(P_2^\ast=(c_0\gamma_1-c_1\gamma_0)/(c_1\gamma_2-c_2\gamma_1)\).
    ...
    \emph{Respuestas}
    \begin{enumerate}
        \item Desarrollado en el capitulo, siga el desarrollo.
        \item Debemos remplazar \(c_n\) por su conjunto de números, lo que nos quedaria que 
        \begin{equation}
        \begin{aligned}
            P_1^* &= \frac{(a_2 - b_2)(\alpha_0 - \beta_0) - (a_0 - b_0)(\alpha_2 - \beta_2)}{(a_1 - b_1)(\alpha_2 - \beta_2) - (a_2 - b_2)(\alpha_1 - \beta_1)} \\
            P_2^* &= \frac{(a_0 - b_0)(\alpha_1 - \beta_1) - (a_1 - b_1)(\alpha_0 - \beta_0)}{(a_1 - b_1)(\alpha_2 - \beta_2) - (a_2 - b_2)(\alpha_1 - \beta_1)}
        \end{aligned}
        \end{equation}
        \item Solución
        \begin{equation}
            \begin{aligned}
                P_1^* &= \frac{114}{34} = \frac{57}{17} \qquad \quad &&P_2^* = \frac{118}{34}=\frac{59}{17} \\
                Q_1^* &= \frac{194}{17}  \qquad \quad &&Q_2^* = \frac{143}{17}
            \end{aligned}
        \end{equation}
    \end{enumerate}
\end{ejercicio}
