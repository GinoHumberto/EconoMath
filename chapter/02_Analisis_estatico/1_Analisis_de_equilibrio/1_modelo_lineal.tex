...
\begin{ejercicio}
    \begin{enumerate}
        ...
        \item Según la ecuación \(Q^\ast= (ad-bc)/(b+d)\), para que \(Q^\ast\) sea positiva, es necesario que la expresión \((ad-bc)\)tenga el mismo signo algebraico que \(b+d\). Compruebe que esta condición se satisface en realidad en los modelos de los problemas 1 y 2.
